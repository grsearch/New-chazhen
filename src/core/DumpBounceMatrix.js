  ...
  _confirmation(profile, dump, toxic) {
    ...
    return {
      ...
      executionPlan: {
        ...
        requireStrictlyAfterEntryTransaction: true,
        requireStrictlyAfterEntryFill: true,
        requireStrictlyAfterExitReference: true,
      ...
      snapshot: {
        ...
        researchKind: 'DIRECT_DUMP_MANAGED_MATRIX_V3',
